...
label1 = Label(frame, text=f"inside is a sleeping arachnid and a chest").grid(column=0, row=0)
laebl2 = Label(frame, text=f"do you want to fight the arachnid, open the chest or leave?").grid(column=0, row=1)
